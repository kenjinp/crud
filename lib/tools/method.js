    ...
    function next(e, d, q, m) {
      ...
      if (e) {
        if (!responded && !req.timedout) {
          ...
          //If a status code is provided in the error object, use it. Otherwise defer to default behavior of 200
          res.status(e.status || 200);
          //If a message field is provided in the error object, use it. Otherwise defer to default behavior of using the entire argument
